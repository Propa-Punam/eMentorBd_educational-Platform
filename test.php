          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="#home-section" class="nav-link" style="color: #333">Home</a></li>
                <li><a href="#courses-section" class="nav-link" style="color: #333">Courses</a></li>
                <li><a href="#programs-section" class="nav-link" style="color: #333">Programs</a></li>
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="#contact-section" class="nav-link"><span>Username</span></a></li>
              </ul>
            </nav>
